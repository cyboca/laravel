...
<div id="floatTop" class="floatTop">
    ...
    <img id="closeButton" onClick="closeWindow()" class="close" src="../img/close_black.png"/>
    <div class="signInterface">
        <h1>用户登录</h1>
        <div class="inputGroup">
            <form name="sign" method="post" action="login.php">
...
<div id="floatTopRegister" class="floatTopRegister">
    <div class="shadow"></div>
    <img id="closeButtonImg" onClick="closeWindow()" class="close" src="../img/close_black.png"/>
    <div class="signInterface reigsterInterface">
        <h1>用户注册</h1>
        <div class="inputGroup">
            <form name="register" method="post" action="register.php" onsubmit="return validcheck()">
